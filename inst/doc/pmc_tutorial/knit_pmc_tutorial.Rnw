...
% \SweaveOpts{dev=tikz, external=TRUE, width=5, height=5, align=center, message=FALSE, warning=FALSE, include=FALSE}
...
invisible(capture.output( # hide geiger's messages 
