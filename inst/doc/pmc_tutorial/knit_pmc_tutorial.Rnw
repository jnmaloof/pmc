...
% \SweaveOpts{dev=tikz, external=TRUE, width=5, height=5, align=center, message=FALSE, warning=FALSE}
...
We can use this to extract the parameter of interest
