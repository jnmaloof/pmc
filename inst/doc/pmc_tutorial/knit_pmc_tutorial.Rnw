...
% \SweaveOpts{fig.width=5, fig.height=5, fig.align='center', cache=FALSE, message=FALSE, warning=FALSE}
...
\begin{figure}
\begin{center}
<<allpars, fig.height=7, fig.width=7, cache=FALSE>>=
